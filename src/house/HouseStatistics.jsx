        ...
        <>            <AdminNavigationBar house={house}/>
            ...
            <div
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-2xl border border-white/50">
                    <div className="mb-8">
                        <p className="text-indigo-600 font-bold text-xs uppercase tracking-widest mb-1">Statistics</p>
                    ...
                    <div className="flex flex-col gap-3 mb-6">
                        ...
                        <div className="flex gap-3">
                            <div className="flex flex-col gap-1.5 flex-1">
                                <label className="text-xs font-bold text-gray-700 uppercase tracking-wide">From</label>
                                <input
                                    type="date"
                                    value={startDate}
                                    min={earliestDate}
                            ...
                            <div className="flex flex-col gap-1.5 flex-1">
                                <label className="text-xs font-bold text-gray-700 uppercase tracking-wide">To</label>
                                <input
                                    type="date"
                                    value={endDate}
                                    min={startDate}
                    ...
                    {!tasks || tasks.length === 0 ? (
                        <p className="text-gray-400 italic text-sm">No tasks available for this period.</p>
                    ) : (() => {
                            ...
                            <>
                                                ...
                                                {stats.map((stat, i) => (
                                                    <div key={i} className="mt-3">
                                                        <div className="flex items-center justify-between mb-1.5">
                                                            ...
                                                            {stat.total} / {stat.expected} completions
                                                        </span>
                                                        </div>
                                ...
                                {totalMinutes > 0 && (
                                    <div
                                        ...
                                        <span className="text-xs font-bold text-indigo-700 uppercase tracking-wide">Total time spent</span>
                                        <span
